...
local v142 = Instance.new("Sound")
    v142.SoundId = "rbxassetid://" .. 131489490
    v142.Looped = false
...
local Red1 = Color3.fromRGB(200, 0, 0)
local Red2 = Color3.fromRGB(255, 0, 0)
...
for _, Part in ipairs(Neons) do
    ...
    local v3 = Instance.new("ColorCorrectionEffect")
        ...
        if vu51.Parent and not vu51:GetAttribute("NoAI") then
            ...
            if v65 then
                if game.Players.LocalPlayer.Character:FindFirstChild("Crucifix") then
                    ...
                    v78.Name = "cruxy"
                    v78.Anchored = true
                    v78.Color = Color3.fromRGB(3,94,252)
...
CustomGitSound("https://raw.githubusercontent.com/Voor-Pr00/Eye/refs/heads/main/DOORS-UNUSED-SOUNDTRACK-Stress%20(mp3cut.net).mp3", 1, "crucifix")
    ...
    DefaultConfig = loadstring(game:HttpGet("https://raw.githubusercontent.com/lelele78/ProtectSecurity.18/refs/heads/main/DefautConfig"))(),                                               Functions = loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/Utilities/main/Functions.lua"))()
                    ...
                    local v82 = game.Workspace.WH1T3
                    if typeof(v81) == "Instance" and v81.ClassName == "Model" then
                        v81:MoveTo(v82:FindFirstChildWhichIsA("BasePart").CFrame.Position - Vector3.new(0, pu38.Config.HeightOffset, 0) - Vector3.new(0, 3, 0))
                        local v83 = game.Workspace.WH1T3:Clone()
                        v83.Parent = game.Workspace
                        v83.Name = "SmilerClone"
                        v81.Entity.CFrame = v83:FindFirstChildWhichIsA("BasePart").CFrame
                        vu51:Destroy()
                        v82:Destroy()
                        Color3.fromRGB()
                        local v84 = ColorSequence.new({
    ColorSequenceKeypoint.new(0, Color3.fromRGB(3, 94, 255)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(3, 94, 255))
})
                        if true == true then
                            local v85 = next
                        ...
                        local v89 = {
                            Position = v83:FindFirstChildWhichIsA("BasePart").CFrame.Position + Vector3.new(0, 3, 0)
                        }
                        local v90 = {
                            Position = v83:FindFirstChildWhichIsA("BasePart").CFrame.Position - Vector3.new(0, 18, 0)
                        }
                        local v91 = v77:Create(v83:FindFirstChildWhichIsA("BasePart"), TweenInfo.new(2), v89)
                        ...
                        wait(2)
                        local v93 = next
                        local v94, v95 = v83:FindFirstChildWhichIsA("BasePart"):GetDescendants()
                        while true do
                            local v96
                            v95, v96 = v93(v94, v95)
                            if v95 == nil then
                        ...
                        local v97 = v77:Create(v83:FindFirstChildWhichIsA("BasePart"), TweenInfo.new(3), v90)
...
DoorsNotify({
    ...
    Description = "You wont crash my game today.",
    Reason = "Used Crucifix on \'\'WH1T3\'\'",
    Image = "rbxassetid://11678978952",
    Time = 5
})
...
local vu138 = vu170.createEntity({
    CustomName = "WH1T3",
    Model = "https://github.com/beanzjsjwj/doors-monsters-models/raw/refs/heads/main/white_part2.rbxm",
    Speed = 350,
    DelayTime = 6.5,
    HeightOffset = 0,
    CanKill = true,
    ...
    Jumpscare = {
        true,
        { 
            Image1 = "rbxassetid://11678978952",
            Image2 = "rbxassetid://11678978952",
            Shake = true,
            Sound1 = {
                5263560896,
                {
